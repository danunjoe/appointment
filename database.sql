...
INSERT INTO "public"."appointment" ("id", "uid", "name", "desc", "status_id", "is_archived", "is_active", "is_delete", "created_dt", "created_by", "created_by_name", "updated_dt", "updated_by", "updated_by_name") OVERRIDING SYSTEM VALUE VALUES (3, '7596f251-47d3-4e18-b651-4852933382bd', 'Appointment 1', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. In id aliquet tellus. Ut fringilla consectetur lacus eget faucibus. Sed tempus nunc quis quam pretium faucibus. Cras dapibus consectetur interdum. Vestibulum ac facilisis ante. Praesent posuere fermentum purus, at ornare tortor accumsan quis. Nulla facilisi. Donec ornare vulputate orci sit amet feugiat. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Aliquam erat volutpat. Phasellus ut ex metus.', 3, 'f', 't', 'f', '2023-01-01 00:00:00', 1, 'โรบินฮู้ด', '2023-09-12 00:59:15.071', 2, 'แบทแมน');
COMMIT;
...
INSERT INTO "public"."appointment_comment" ("id", "appointment_id", "comment", "is_active", "is_delete", "created_dt", "created_by", "created_by_name", "updated_dt", "updated_by", "updated_by_name") OVERRIDING SYSTEM VALUE VALUES (23, 3, 'ทดสอบ', 't', 'f', '2023-09-11 23:32:16.231', 2, 'แบทแมน', '2023-09-11 23:32:16.231', 2, 'แบทแมน');
INSERT INTO "public"."appointment_comment" ("id", "appointment_id", "comment", "is_active", "is_delete", "created_dt", "created_by", "created_by_name", "updated_dt", "updated_by", "updated_by_name") OVERRIDING SYSTEM VALUE VALUES (24, 3, 'ทดสอบ', 't', 'f', '2023-09-11 23:49:53.287', 2, 'แบทแมน', '2023-09-11 23:49:53.287', 2, 'แบทแมน');
INSERT INTO "public"."appointment_comment" ("id", "appointment_id", "comment", "is_active", "is_delete", "created_dt", "created_by", "created_by_name", "updated_dt", "updated_by", "updated_by_name") OVERRIDING SYSTEM VALUE VALUES (25, 3, 'ทดสอบ', 't', 'f', '2023-09-11 23:52:54.522', 2, 'แบทแมน', '2023-09-11 23:52:54.522', 2, 'แบทแมน');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."user" ("id", "name", "email", "pwd", "is_active", "is_delete", "created_dt", "created_by", "created_by_name", "updated_dt", "updated_by", "updated_by_name") OVERRIDING SYSTEM VALUE VALUES (1, 'โรบินฮู้ด', 'user1@robinhood.co.th', '$2a$10$XGstLSu3NdNZLapS0qdfDu.pOh3jj6174SzDyE0zh3MVRiiIGVfQy', 't', 'f', '2023-01-01 00:00:00', 0, 'test', '2023-01-01 00:00:00', 0, 'test');
INSERT INTO "public"."user" ("id", "name", "email", "pwd", "is_active", "is_delete", "created_dt", "created_by", "created_by_name", "updated_dt", "updated_by", "updated_by_name") OVERRIDING SYSTEM VALUE VALUES (2, 'แบทแมน', 'user2@robinhood.co.th', '$2a$10$XGstLSu3NdNZLapS0qdfDu.pOh3jj6174SzDyE0zh3MVRiiIGVfQy', 't', 'f', '2023-01-01 00:00:00', 0, 'test', '2023-01-01 00:00:00', 0, 'test');
...
-- ----------------------------
SELECT setval('"public"."appointment_comment_id_seq"', 84, true);
...
-- ----------------------------
ALTER TABLE "public"."appointment" ADD CONSTRAINT "appointment_status_id_fkey" FOREIGN KEY ("status_id") REFERENCES "public"."status" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
